<template>
  <AdminLayout>
    ...
    >
      <v-btn class="primary-btn add-btn" elevation="0" @click="dialog = true">
        <v-icon icon="mdi-plus"></v-icon> Add Customer
      </v-btn>
      <v-dialog v-model="dialog" persistent max-width="860px">
        <AddCustomers @close="closeModal"></AddCustomers>
      </v-dialog>
      <DxDataGrid
        class="tenants-table"
            ...
            <DxItem :col-count="2" :col-span="2" item-type="group">
              ...
              <DxItem
                ...
                :validation-rules="[
                  {
                    type: 'required',
                    message: 'organisation Number is required',
                  },
                ]"
              />
              <DxItem
...
import AddCustomers from "../../components/modals/AddCustomers.vue";
import {
  DxDataGrid,
  DxColumn,
  DxPaging,
