            ...
            <v-container>
                <v-row>
                    <v-col cols="12" sm="6" md="6">
                        ...
                        <v-text-field v-model="studentData.name" :placeholder="$t('studentName')" class="mt-2"
                            hide-details="auto" variant="outlined" required></v-text-field>
                    ...
                    <v-col cols="12" md="6">
                        ...
                        <v-text-field v-model="studentData.email" :placeholder="$t('studentEmail')" type="email"
                            hide-details="auto" class="mt-2" variant="outlined"></v-text-field>
                        <div class="text-start">
                    ...
                    <v-col cols="12" md="6">
                        ...
                        <v-text-field v-model="studentData.birth_date" :placeholder="$t('dob')" variant="outlined"
                            hide-details="auto" class="mt-2" type="date" required></v-text-field>
                        <div class="text-start">
                    ...
                    <v-col cols="6" sm="6">
                        ...
                        <v-text-field v-model="studentData.birth_place" :placeholder="$t('birthPlace')" hide-details="auto"
                            class="mt-2" variant="outlined" required></v-text-field>
                        <div class="text-start">
